...
- The `CollectNotificationReferrers` feature must be enabled:
  ```
  --enable-features=CollectNotificationReferrers
  ```
...
2. Launch Edge with `--enable-features=CollectNotificationReferrers`
